        ...
        <div class="card shadow mb-4">
            ...
            <div class="card-body">
                <div class="mb-3">
                    ...
                    <textarea class="form-control" id="icon" name="icon" rows="3">{{ old('icon') }}</textarea>
                </div>
                <div class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    {{-- <textarea class="form-control" id="description" name="description" rows="16">{{ old('description') }}</textarea> --}}
                    <x-text-editor name="description" id="description" :value="old('description') ?? ''" />
                </div>

                <div class="mb-3">
                    <label for="rules" class="form-label">قوانین</label>
                    <x-text-editor name="rules" id="rules" :value="old('rules') ?? ''" />
                </div>
                ...
                <div class="mb-3">
                    ...
                    <select class="form-control" id="parent_id" name="parent_id">
                        ...
                        @foreach ($services as $srv)
                            <option value="{{ $srv->id }}" {{ old('parent_id') == $srv->id ? 'selected' : '' }}>
                                {{ $srv->name }}
                            </option>
                        @endforeach
                    </select>
