...
@section('name', 'افزودن ویدیو جدید')
@section('actions')
    ...
    <form method="POST" action="{{ route('videos.store') }}">
        ...
        <div class="card shadow mb-4">
            <div class="card-header py-3">
                <h6 class="m-0 font-weight-bold text-primary">جزئیات ویدیو</h6>
            </div>
            <div class="card-body">
                <div class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="video" name="video" value="{{ old('video') }}" required>
                </div>
                ...
                <button type="submit" class="btn btn-success">افزودن ویدیو</button>
            </div>
        </div>
    </form>
@endsection
