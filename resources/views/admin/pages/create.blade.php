        ...
        <div class="card shadow mb-4">
            ...
            <div class="card-body">
                ...
                <div class="form-check mb-3">
                    <input type="checkbox" value="1" class="form-check-input" id="is_published" name="is_published"
                        {{ old('is_published') ? 'checked' : '' }}>
                    <label class="form-check-label mr-4" for="is_published">منتشر شود</label>
                </div>
