            ...
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="card shadow">
                    <div class="card-header">
                        <h6 class="m-0 font-weight-bold text-primary">ویرایش مخاطب</h6>
                    </div>
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-xs-12 col-sm-12 col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="tel" name="phone" id="phone" placeholder="شماره تلفن"
                                        class="form-control" value="{{ old('phone', $contact->phone) }}">
                                </div>
                            </div>
                            <div class="col-xs-12 col-sm-12 col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="email" name="email" id="email" placeholder="ایمیل"
                                        class="form-control" value="{{ old('email', $contact->email) }}">
                                </div>
                            </div>
                        </div>
