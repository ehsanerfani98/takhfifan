                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-4">
                                <div class="form-group">
                                    ...
                                    <select name="access" id="access"
                                        ...
                                        <option value="public" {{ old('access') === 'public' ? 'selected' : '' }}>عمومی
                                        </option>
                                        <option value="private" {{ old('access') === 'private' ? 'selected' : '' }}>خصوصی
                                        </option>
                                    </select>
                                    @error('access')
                            ...
                            <div class="col-lg-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="title" id="title" value="{{ old('title') }}"
                                        placeholder="عنوان" class="form-control @error('title') is-invalid @enderror">
                                    @error('title')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="col-lg-4">
                                <div class="form-group">
                                    ...
                                    <select name="type" id="type"
                                        ...
                                        <option value="amount" {{ old('type') === 'amount' ? 'selected' : '' }}>مبلغی
                                        </option>
                                        <option value="percent" {{ old('type') === 'percent' ? 'selected' : '' }}>درصدی
                                        </option>
                                    </select>
                                    @error('type')
                                        <div class="invalid-feedback">{{ $message }}</div>
                            ...
                            <div class="col-lg-3">
                                <div class="form-group">
                                    ...
                                    <input type="number" name="amount" id="amount" value="{{ old('amount') }}"
                                        placeholder="مبلغ" class="form-control @error('amount') is-invalid @enderror">
                                    @error('amount')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="col-lg-3">
                                <div class="form-group">
                                    ...
                                    <input type="number" name="percent" id="percent" value="{{ old('percent') }}"
                                        placeholder="درصد" class="form-control @error('percent') is-invalid @enderror">
                                    @error('percent')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="col-lg-3">
                                <div class="form-group">
                                    ...
                                    <input data-jdp name="expiration" id="expiration" value="{{ old('expiration') }}"
                            ...
                            <div class="col-lg-3">
                                <div class="form-group">
                                    ...
                                    <select name="status" id="status"
                                        ...
                                        <option value="enable" {{ old('status') === 'enable' ? 'selected' : '' }}>فعال
                                        </option>
                                    </select>
                                    @error('status')
                                        <div class="invalid-feedback">{{ $message }}</div>
